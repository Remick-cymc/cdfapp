...
const AddAdmin = () => {
  ...
  const url = 'https://remickewoton.pythonanywhere.com/api/admin_signup';
  ...
  <div className='d-flex justify-content-center mt-5'>
    ...
    <div className='card shadow col-md-6 p-5'>
      ...
      <form action="" onSubmit={handleFormSubmit}>
        ...
        <input type="tel" placeholder='Enter tel(phone)' name='phone' className='phonenumber mb-4' onChange={(e)=>setPhone(e.target.value)}/>
        <input type="password" placeholder='Enter password' name='yourpassword' className='Password mb-4' onChange={(e)=>setPassword(e.target.value)}/>
        <button type="submit" class="btn btn-primary">Register Adimn</button>
